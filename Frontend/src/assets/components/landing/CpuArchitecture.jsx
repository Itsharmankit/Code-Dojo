...
const CpuArchitecture = ({
  ...
  return (
    <svg
      className={`cpu-arch-svg ${className}`}
      width={width}
      height={height}
      viewBox="0 0 200 100"
      style={{ color: 'rgba(155,135,245,0.35)' }}
    >
      {/* ── Paths (circuit lines) ── */}
      <g
        stroke="currentColor"
      ...
      <g>
        ...
        <rect x="85" y="40" width="30" height="20" rx="2"
          fill="#0d0e12" filter="url(#cpu-light-shadow)"
          stroke="rgba(155,135,245,0.3)" strokeWidth="0.4"
        />
        <text x="88.5" y="52.5" fontSize="6.5"
      ...
      <defs>
        ...
        <mask id="cpu-mask-6">
          <path d="M 94.8 95 v -36" strokeWidth="0.5" stroke="white" fill="none"/>
        </mask>
        <mask id="cpu-mask-7">
        ...
        <radialGradient id="cpu-pinkish-grad" fx="1">
          ...
          <stop offset="50%" stopColor="#6d56d9" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
        ...
        <marker id="cpu-circle-marker" viewBox="0 0 10 10" refX="5" refY="5"
          ...
          <circle id="innerMarkerCircle" cx="5" cy="5" r="2"
            fill="rgba(10,6,19,0.9)" stroke="rgba(155,135,245,0.4)" strokeWidth="0.5">
            {animateMarkers && (
        ...
        <linearGradient id="cpu-connection-gradient" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="60%" stopColor="rgba(109,86,217,0.15)" />
        </linearGradient>
